<?php get_header(); ?>
        ...
        <section class="archive-page">
            ...
            <h2 class="search-header"><?php _e('Results for:','portfolio_v') ?> <span><?php echo get_search_query(); ?></span></h2>
            ...
            <p><?php _e('Nothing are found, try something else...','portfolio_v') ?></p>
